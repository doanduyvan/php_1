<?php
	...
	$id = $_GET['id'];
	$one_sanpham = getdata($conn,'sanpham','id',$id);
	$hinhfull = getdata($conn,'hinhsp','id_sanpham',$id);
?>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?php echo $one_sanpham['ten'] ?></h2>
							<div>
							...
							<div>
								<h3 class="product-price"><?php echo number_format($one_sanpham['giakm']); ?> <del class="product-old-price"><?php echo number_format($one_sanpham['giagoc']); ?></del></h3>
								<span class="product-available">Còn <?php echo $one_sanpham['soluong'] ?> Sản phẩm</span>
							</div>
							<p><pre><?php echo $one_sanpham['motangan'] ?></pre></p>
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<input type="number" min="0" value="1" id="slallsp">
								...
								<button class="add-to-cart-btn" <?php 
									if(isset($_SESSION['vaitro'])){
										...
										$id_sp = $id;
										echo "onclick='themspall($id_gh,$id_sp)'";
									}else{
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p><?php echo $one_sanpham['motadai']; ?></p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<?php
						$sanphamfull = getdata($conn,'sanpham');
						foreach($sanphamfull as $key => $value){
						if($key==4){break;}
					?>
					<!-- product -->
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								...
								<h3 class="product-name"><a href="?page=sanpham&id=<?php echo $value['id']; ?>"><?php echo $value['ten'] ?></a></h3>
